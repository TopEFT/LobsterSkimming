...
- Exact Work Queue factory and Lobster production commands remain explicit user-supplied placeholders. Local untracked factory JSON files are not canonical documentation.

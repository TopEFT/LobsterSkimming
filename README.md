...
- Exact Work Queue factory and Lobster production commands remain explicit user-supplied placeholders for LOBALIGN006. Do not infer final commands from examples or old README text.
